    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usertype', models.CharField(choices=[('customer', 'Customer'), ('mamamboga', 'Mama Mboga')], default='mamamboga', max_length=10)),
                ('address', models.CharField(default='Nairobi, Kenya', max_length=300)),
            ],
            options={
                'verbose_name': 'User',
